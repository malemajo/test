...
class WebServer {
      ...
      if (request == null) {
        ...
        if (request.length() == 0) {
          ...
          try {
            ...
            builder.append("Content-Type: text/html; charset=utf-8\n");
            builder.append("\n");
            builder.append("Error: Unable to parse query parameters");
          ...
          if (num1Str == null || num2Str == null || num1Str.isEmpty() || num2Str.isEmpty()) {
            ...
            builder.append("Content-Type: text/html; charset=utf-8\n");
            builder.append("\n");
            builder.append("Error: Both parameters num1 and num2 are required");
          } else {
            try {
              ...
              builder.append("Content-Type: text/html; charset=utf-8\n");
              builder.append("\n");
              builder.append("Error: Parameters num1 and num2 must be valid integers");
            }
          }
          ...
          if (query == null) {
            ...
            builder.append("Content-Type: text/html; charset=utf-8\n");
            builder.append("\n");
            builder.append("Error: Parameter query is required");
          } else {
            ...
            try {
              ...
              for (int i = 0; i < repos.length(); i++) {
                ...
                repoInfo.put("fullname", repo.getString("full_name"));
                repoInfo.put("id", repo.getInt("id"));
                repoInfo.put("loginname", repo.getJSONObject("owner").getString("login"));
                responseArray.put(repoInfo);
              }
              builder.append(responseArray.toString());
          ...
          if (city == null || country == null) {
            ...
            builder.append("Content-Type: text/html; charset=utf-8\n");
            builder.append("\n");
            builder.append("Error: Both city and country parameters are required");
          } else {
            // Assume getWeather is a method that fetches weather data
            String weatherData = getWeather(city, country);
            builder.append("HTTP/1.1 200 OK\n");
            builder.append("Content-Type: text/html; charset=utf-8\n");
            builder.append("\n");
          ...
          if (text == null || target == null) {
            ...
            builder.append("Content-Type: text/html; charset=utf-8\n");
            builder.append("\n");
            builder.append("Error: Both text and target parameters are required");
          } else {
            // Assume translateText is a method that translates text
            String translatedText = translateText(text, target);
            builder.append("HTTP/1.1 200 OK\n");
            builder.append("Content-Type: text/html; charset=utf-8\n");
            builder.append("\n");
  ...
  private String getWeather(String city, String country) {
    // Simulate fetching weather data from an API and returning JSON data
  ...
  private String translateText(String text, String target) {
    // Simulate fetching translation from an API and returning JSON data
    String translatedText = "hola";  // Assume text is always 'hello' and target is always 'es' for simplicity
    String jsonData = String.format(
        "{" +
            "\"original_text\": \"%s\"," +
            "\"translated_text\": \"%s\"," +
  ...
  public static Map<String, String> splitQuery(String query) throws UnsupportedEncodingException {
    ...
    for (String pair : pairs) {
      ...
      if (idx == -1) { // Check if "=" character is found in the pair
